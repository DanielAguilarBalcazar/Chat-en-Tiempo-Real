  ...
  render() {
    return (this.props.activeUser && <Fragment>
      ...
      <div className="border-top border-gray w-100 px-4 d-flex align-items-center bg-light" style={{ minHeight: 90 }}>
        <textarea className="form-control px-3 py-2" onKeyUp={this.handleKeyUp} placeholder="Enter a chat message" style={{ resize: 'none', color: '#000' }}></textarea>
        <button onClick={this.handleSend} className="btn btn-primary ml-2" style={{ minWidth: 80 }}>Enviar</button>
      </div>
